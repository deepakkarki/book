...
The implementation discussed in this book can be found in
...
We use NetBSD release cycle terminology throughout this book.
...
\textit{-current}.  The source code used in this book is
...
whenever 5.99.48 is used in this book, it stands for -current
at 20110331.
